...
class SurveyUnanswerScreen extends StatefulWidget {
  final Survey survey;

  const SurveyUnanswerScreen({super.key, required this.survey});

  @override
  State<SurveyUnanswerScreen> createState() => _SurveyUnanswerScreenState();
}

class _SurveyUnanswerScreenState extends State<SurveyUnanswerScreen> {
  bool isLoading = true;
